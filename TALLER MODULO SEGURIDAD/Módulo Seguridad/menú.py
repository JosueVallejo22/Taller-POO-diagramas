...
while alternativa != "3":
    ...
    if alternativa == "1":
        ...
        while alternativa1 != "2":
            os.system("cls")
            alternativa1 = sub.menu(["1) Validación de Usuario","2) Salir"],"Opciones de Usuario")
            os.system("cls")
            ...
            if alternativa1 == "1":
                ...
                while True:
                    cédula = input("Ingresar su número de cédula: ")
                ...
                while alternativa1 != "5":
                    ...
                    alternativa1 = sub.menu(["1).Ingresar datos", "2).Mostrar datos"],"Opciones de Usuario")
                            
                    if alternativa1 == "1": 
                            os.system("cls")
                            nombre = input("Ingrese un nombre: ")
                            apellido = input("Ingrese un apellido: ")
                            dirección = input("Ingrese una dirección: ")
        ...
        while alternativa1 != "2":
            ...
            if alternativa1 == "1":
                ...
                while alternativa1 != "5":
                    ...
                    alternativa1 = sub.menu(["1).Ingresar datos", "2).Mostrar datos", "5).Salir"],"Opciones de Administrador")
